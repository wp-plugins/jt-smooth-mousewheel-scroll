...
function jtCgs_ss_enqueue_scripts(){
    ...
    wp_enqueue_style('jtCgs_ss-wheelscroll-style', Plugins_url('/css/jt-wheelscroll-admin.css', __FILE__), false, '1.0.0');
}
...
function jtCgs_ss_Show_script(){
    if(wp_is_mobile() == false){
        ...
        wp_enqueue_script('jtCgs_ss-show-jquery', Plugins_url('/js/jt-wheelscroll-show.js', __FILE__), array('jquery'), '1.0.0', true);
    }
